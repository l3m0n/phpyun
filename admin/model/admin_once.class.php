...
class admin_once_controller extends common
{
	...
	function save_action(){
		...
		if($_POST['id']){
			$tid=$this->obj->DB_update_all('once_job',"`title`='".$_POST['title']."',`companyname`='".$_POST['companyname']."',`phone`='".$_POST['phone']."',`linkman`='".$_POST['linkman']."',`require`='".$_POST['require']."',`edate`='".$_POST['edate']."',`pic`='".$_POST['pic']."',`status`='1',`did`='".$this->config['did']."'".$value,"`id`='".$_POST['id']."'");			
			$msg="修改成功!";			
		}
		if($tid){
