...
class model{
    ...
    protected $sitetable=array('ad','ad_order','admin_announcement','zhaopinhui','zhaopinhui_com','zhaopinhui_pic','news_base','news_content','resume_expect','member','company_job','resume','friend_info','user_entrust','user_entrust_record','down_resume','look_resume','company','company_cert','company_msg','company_news','company_order','company_pay','company_product','once_job','resume_tiny','userid_msg','userid_job','look_job','admin_link','report','invoice_record','company_statis','partjob','hotjob');
	...
	public function __construct($db,$def,$logininfo,$sitetable,$sitetadd){
