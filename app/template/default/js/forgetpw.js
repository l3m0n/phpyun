...
function checklink(){
	...
	if(isjsMobile(linkphone)==false && isjsTell(linkphone)==false){
		layer.msg("请填写正确的联系电话",2,8);return false;
	}
	if(check_email(linkemail)==false){
		layer.msg("请填写正确的申诉邮箱",2,8);return false;
	}
	var sendtype=$("input[name=sendtype]:checked").val();
