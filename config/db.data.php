...
$arr_data = array (
	...
	'source' => array ('1'=>'网页','2'=>'手机','3'=>'App','4'=>'微信','6'=>'采集'),
	...
	'cache' => array ('1'=>"区域",'2'=>"行业",'3'=>"职位",'4'=>"个人会员分类",'5'=>"企业会员分类",'6'=>"导航",'7'=>"网站缓存",'8'=>"SEO设置",'9'=>"分站",'10'=>"关键字",'11'=>'友情链接','12'=>'新闻分类','13'=>'单页面分类','14'=>'广告','15'=>'兼职分类','18'=>'商品分类','19'=>'数据库'),
	'faceurl' => "/config/face/",
	...
	'seomodel'=>array("index"=>"首页","job"=>"找工作","part"=>"兼职","com"=>"公司","resume"=>"找人才","news"=>"新闻","hr"=>"工具箱","zph"=>"招聘会","ask"=>"问答","evaluate"=>"测评","once"=>"店铺招聘","tiny"=>"普工简历","gg"=>"公告","other"=>"其它"
	),
	'seoconfig'=>array(
		'public'=>array(
			'webname'=>"网站名称",
