...
<div class="main">
    <textarea class="pact" readonly="readonly">
        安装协议： 本授权协议适用且仅适用于PHPYUN.4.2 版本，宿迁鑫潮信息技术有限公司拥有对本授权协议的最终解释权。 I. 协议许可的权利
        ...
        PHPYUN4.2，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。
    </textarea>
</div>
<div class="bottom">
