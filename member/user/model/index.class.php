...
class index_controller extends user{
	function index_action(){
		...
		$resume = $this->obj->DB_select_once("resume","`uid`='".$this->uid."'","`def_job`,`name`,`status`,`email`,`telphone`,`idcard`,`moblie_status`,`email_status`,`idcard_status`,`status`,`description`");
